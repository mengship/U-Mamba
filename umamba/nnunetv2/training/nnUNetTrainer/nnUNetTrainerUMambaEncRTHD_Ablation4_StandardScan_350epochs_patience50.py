...
from nnunetv2.training.nnUNetTrainer.nnUNetTrainerUMambaEncRTHD_Ablation4_StandardScan import nnUNetTrainerUMambaEncRTHD_Ablation4_StandardScan


class nnUNetTrainerUMambaEncRTHD_Ablation4_StandardScan_350epochs_patience50(nnUNetTrainerUMambaEncRTHD_Ablation4_StandardScan):
    """
    消融实验 #4: 常规扫描版
    ...
    使用方法:
        nnUNetv2_train DATASET_ID CONFIG FOLD -tr nnUNetTrainerUMambaEncRTHD_Ablation4_StandardScan_350epochs_patience50
    """
