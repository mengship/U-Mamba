...
from nnunetv2.training.nnUNetTrainer.nnUNetTrainerUMambaEncRTHD import nnUNetTrainerUMambaEncRTHD


class nnUNetTrainerUMambaEncRTHD_350epochs_patience50(nnUNetTrainerUMambaEncRTHD):
    """
    nnUNet Trainer for UMambaEnc with RTHD
    训练配置: 350 epochs, patience 50 (早停)

    使用方法:
        nnUNetv2_train DATASET_ID CONFIG FOLD -tr nnUNetTrainerUMambaEncRTHD_350epochs_patience50
    """
