...
class nnUNetTrainerUMambaEncRTHD_StageAwareDecoder_350epochs_patience50(nnUNetTrainerUMambaEncRTHD_StageAwareDecoder):
    """
    RTHD Stage-Aware Decoder (第二版) with extended training schedule
    训练配置: 350 epochs, patience 50 (早停)

    第二版增强策略：
    - Stage-aware RTHD Decoder (partial mode)
    - Semantic-guided Skip Fusion Gate
    - Boundary-aware Segmentation Attention
    - High-low Frequency Structure Recovery is kept for ablation only
